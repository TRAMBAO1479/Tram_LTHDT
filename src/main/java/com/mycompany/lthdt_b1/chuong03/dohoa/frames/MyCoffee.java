...
public class MyCoffee extends javax.swing.JInternalFrame {
    ...
    for ( int i = 0; i < managers.length; i++){
        cboQuanLy.addItem(managers[i].getHoten());
    }
        DefaultTableModel model = (DefaultTableModel) tblCoffeeShop.getModel();
        model.setRowCount(0);
        CoffeeShop[] Shop = managers[0].getShops();
    ...
    private void initComponents() {
        ...
        cboQuanLy.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));
        cboQuanLy.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cboQuanLyItemStateChanged(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cboQuanLy, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void cboQuanLyItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cboQuanLyItemStateChanged
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tblCoffeeShop.getModel();
        model.setRowCount(0);
            int index = cboQuanLy.getSelectedIndex();
    ...
    }//GEN-LAST:event_cboQuanLyItemStateChanged
